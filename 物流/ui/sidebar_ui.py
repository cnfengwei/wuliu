...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../icon/activity-feed-32.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.products_btn_2.setIcon(icon)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../home-4-32.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.customers_btn_2.setIcon(icon2)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../icon/account-logout-64.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("../icon/user-48.ico"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.user_add_btn = QtWidgets.QPushButton(parent=self.page_7)
        ...
        self.table_users = QtWidgets.QTableWidget(parent=self.page_7)
        self.table_users.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.CursorShape.IBeamCursor))
        self.table_users.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.AllEditTriggers)
        ...
        self.user_save_btn = QtWidgets.QPushButton(parent=self.page_7)
        ...
        self.user_del_btn = QtWidgets.QPushButton(parent=self.page_7)
        self.user_del_btn.setCheckable(True)
        self.user_del_btn.setAutoExclusive(False)
        self.user_del_btn.setObjectName("user_del_btn")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "三方单号"))
        item = self.tableWidget_2.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "始发网点"))
        item = self.tableWidget_2.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "目的网点"))
        item = self.tableWidget_2.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "车牌号"))
        item = self.tableWidget_2.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "计费车型"))
        item = self.tableWidget_2.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "三方司机"))
        item = self.tableWidget_2.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "核实司机"))
        ...
        self.user_add_btn.setText(_translate("MainWindow", "新增"))
        ...
        item.setText(_translate("MainWindow", "权限", "0"))
        item = self.table_users.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "备注", "0"))
        self.user_save_btn.setText(_translate("MainWindow", "保存"))
        self.user_del_btn.setText(_translate("MainWindow", "删除"))
